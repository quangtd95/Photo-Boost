...
public class CustomFeatureBar extends RelativeLayout {
    ...
    public enum TYPE {
        STICKER, ADJUST, EFFECT, FILTER, BLUR, TEXT, CROP
    }
    ...
    public void init() {
        ...
        mIcons = new int[]{R.drawable.ic_sticker, R.drawable.ic_adjust, R.drawable.ic_effect, R.drawable.ic_filter, R.drawable.ic_blur, R.drawable.ic_text, R.drawable.ic_crop};
